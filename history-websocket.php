...
<body>
    ...
    <script>
        ...
        function initWebSocket() {
            try {
                debug('Connexion WebSocket à: ' + config.wsUrl);
                ws = new WebSocket(config.wsUrl);

                ws.onopen = () => {
                    debug('WebSocket connecté');
                };
                ...
                ws.onmessage = (event) => {
                    ...
                    if (data.type === 'auth_required') {
                        ...
                        debug('Authentification réussie!');
                        wsAuthenticated = true;
                    } else if (data.type === 'auth_invalid') {
                        debug('Authentification échouée: ' + data.message, true);
                ...
                ws.onerror = (error) => {
                    debug('Erreur WebSocket: ' + error, true);
                };
